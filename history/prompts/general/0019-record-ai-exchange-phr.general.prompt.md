...
user: Claude Code
command: /sp.phr
labels: ["phr","documentation","general"]
links:
  spec: null
  ticket: null
  adr: null
  pr: null
files:
 - history/prompts/general/0019-record-ai-exchange-phr.general.prompt.md
tests:
 - none
---
...
- `none` → Suggested next steps or "none"
- `Captured full prompt verbatim to ensure traceability.` → One key insight
...
- ✅ Impact: Prepared and saved a PHR template file with full prompt text preserved; metadata populated for routing and audit.
- 🧪 Tests: none
- 📁 Files: history/prompts/general/0019-record-ai-exchange-phr.general.prompt.md
- 🔁 Next prompts: none
- 🧠 Reflection: Captured full prompt verbatim to ensure traceability.

## Evaluation notes (flywheel)

- Failure modes observed: none observed - script executed successfully.
- Graders run and results (PASS/FAIL): N/A
- Prompt variant (if applicable): none
- Next experiment (smallest change to try): Validate with multi-line prompts to ensure full capture.
